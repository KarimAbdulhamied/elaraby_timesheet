 ...
 **  This version of the file includes one method (extractIsolatedEffortsTimesheetData()) that extracts the timesheets' data that contain isolated efforts
 */
...
public class Elaraby_TimesheetInfo_mxJPO {
	...
	public void extractIsolatedEffortsTimesheetData(Context context, String[] args) throws Exception {
		System.out.println("Executing the method extractIsolatedEffortsTimesheetData...");
		...
		System.out.println("Successfully executed the method extractIsolatedEffortsTimesheetData");
	}
